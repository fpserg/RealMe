...
Prepare Artem’s dividend report for production

LI

Ozon conference call and results review done

Moscow Exchange report feedback done

Collecting data on coverage from analysts to send to Moscow Exchange for annual IR rating

LI

Dividend report updated and prepared for production. Final check tomorrow morning before release.

At department meeting Andrey set hard deadlines for Strategy and Platform reports - mid-September. Sounds challenging.

Send coverage list to exchange tomorrow morning.
